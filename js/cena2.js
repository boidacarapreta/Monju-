...
cena3.preload function () 
    ...
    this.load.spritesheet('button', "assets/button.png", { frameWidth: 36, frameHeight: 18 });
    }
...
death = this.sound.add("death");
            ...
            //cima
            spikes.create(400, 285, 'spike').setScale(0.2).refreshBody() && spikes.create(650, 285, 'spike').setScale(0.2).refreshBody();

            escada.create(30, 198, 'escada').setScale(0.5).refreshBody() && escada.create(260, 98, 'escada').setScale(0.5).refreshBody() && escada.create(480, 198, 'escada').setScale(0.5).refreshBody() && escada.create(730, 120, 'escada').setScale(0.5).refreshBody(); 

            //baixo
            spikes.create(400, 633, 'spike').setScale(0.2).refreshBody() && spikes.create(650, 633, 'spike').setScale(0.2).refreshBody();

            escada.create(30, 544, 'escada').setScale(0.5).refreshBody() && escada.create(260, 446, 'escada').setScale(0.5).refreshBody() && escada.create(480, 546, 'escada').setScale(0.5).refreshBody() && escada.create(730, 468, 'escada').setScale(0.5).refreshBody();
